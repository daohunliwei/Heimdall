-- Heimdall 种子数据初始化
-- 列名使用 snake_case（与 SqlSugar CodeFirst 生成的结构一致）
...
-- ===== 默认提示词模板 =====
INSERT INTO prompt_templates ("id", "slug", "name", "layer", "scope_type", "category", "template_content", "is_system", "is_active", "priority", "version", "created_at", "updated_at")
VALUES
