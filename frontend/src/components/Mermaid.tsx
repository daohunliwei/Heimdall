...
mermaid.initialize({
  ...
  themeCSS: `
    ...
    text.actor { fill: #171717; stroke: none; }
    .messageText { fill: #171717; stroke: none; }
    .messageLine0, .messageLine1 { stroke: #2563eb; }
    .noteText { fill: #171717; }
    ...
    [data-theme="dark"] .node path {
      fill: #171717; stroke: #262626;
    }
    [data-theme="dark"] .edgePath .path { stroke: #3b82f6; }
    [data-theme="dark"] .edgeLabel { color: #ededed; }
    [data-theme="dark"] .label { color: #ededed; }
    [data-theme="dark"] .cluster rect { fill: #171717; stroke: #262626; }
    [data-theme="dark"] .actor { fill: #171717; stroke: #262626; }
    [data-theme="dark"] text.actor { fill: #ededed; }
    [data-theme="dark"] .messageText { fill: #ededed; font-weight: 500; }
    [data-theme="dark"] .messageLine0, [data-theme="dark"] .messageLine1 { stroke: #3b82f6; }
    [data-theme="dark"] .noteText { fill: #ededed; }
    [data-theme="dark"] #sequenceNumber { fill: #ededed; }
    [data-theme="dark"] text.sequenceText { fill: #ededed; font-weight: 500; }
    [data-theme="dark"] text.loopText, [data-theme="dark"] text.loopText tspan { fill: #ededed; }
    ...
    [data-theme="dark"] .label, [data-theme="dark"] text {
      fill: #a3a3a3 !important;
    }
    .clickable { transition: all 0.2s ease; }
...
const FullScreenModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 p-4">
      <div
        ref={modalRef}
        className="card max-w-5xl max-h-[90vh] w-full overflow-hidden flex flex-col"
      >
  ...
  useEffect(() => {
    ...
    const renderChart = async () => {
      ...
      try {
        ...
        // Parse first so invalid Mermaid falls back quietly to source text.
    ...
    return (
      <div className={`border border-[var(--highlight)]/30 rounded-md p-4 bg-[var(--highlight)]/5 ${className}`}>
        ...
        <div className="mt-3 text-xs text-[var(--muted)]">
          Syntax error in diagram — cannot render.
        </div>
      </div>
    );
  }
